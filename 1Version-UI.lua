...
function OneVersion:AddAddonListItem(index, item)
  ...
  wnd:FindChild("Mine"):FindChild("Major"):SetText(tostring(item.mine.major or 0))
  wnd:FindChild("Mine"):FindChild("Minor"):SetText(tostring(item.mine.minor or 0))
  wnd:FindChild("Mine"):FindChild("Patch"):SetText(tostring(item.mine.patch or 0))
  wnd:FindChild("Reported"):FindChild("Major"):SetText(tostring(item.reported.major or 0))
